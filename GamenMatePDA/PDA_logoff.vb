    ...
    Public Shared Function ExitWindows(ByVal flags As ShutdownFlag) As Boolean
        ...
        Try
            ...
            If Environment.OSVersion.Platform = PlatformID.Win32NT Then
                ...
                flag = flag And Not PDA_logoff.ShutdownFlag.Force
                flag = flag And Not PDA_logoff.ShutdownFlag.ForceIfHung
            ...
            Else
                ...
                flags = flags And Not PDA_logoff.ShutdownFlag.ForceIfHung

...
#Region "  ﾒｲﾝ処理                                                                              "
    ...
    Public Overrides Function ExecCmd(ByVal strMSG_RECV As String, ByRef strMSG_SEND As String) As RetCode
        ...
        Try
            ...
            objSVR_100303.FTRK_BUF_NO = intBufNo                        'ﾊﾞｯﾌｧ№
            objSVR_100303.FPALLET_ID = strDenbunDtl(DSPPALLET_ID)       'ﾊﾟﾚｯﾄID
            ...
            If IsNotNull(objTPLN_CARRY_QUE.XPALLET_ID_AITE) Then
                ...
                If objTPRG_TRK_BUF_RELAY.FTRK_BUF_NO = intBufNo Then
                    ...
                    If Not (objTPRG_TRK_BUF_RELAY.FTRK_BUF_NO = FTRK_BUF_NO_J9000 And objTPRG_TRK_BUF_RELAY.FRES_KIND = FRES_KIND_SZAIKO) Then
                        ...
                        'ﾄﾗｯｷﾝｸﾞｷｬﾝｾﾙ
                        '************************
                        Dim objSVR_100303_Aite As New SVR_100303(Owner, ObjDb, ObjDbLog)    'ﾄﾗｯｷﾝｸﾞｷｬﾝｾﾙｸﾗｽｸﾗｽ
                        objSVR_100303_Aite.FTRK_BUF_NO = intBufNo                           'ﾊﾞｯﾌｧ№
                        objSVR_100303_Aite.FPALLET_ID = objTPLN_CARRY_QUE.XPALLET_ID_AITE   'ﾊﾟﾚｯﾄID
                        objSVR_100303_Aite.MENTE_CANCEL()                                   'ﾄﾗｯｷﾝｸﾞｷｬﾝｾﾙ

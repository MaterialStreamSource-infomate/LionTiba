...
#Region "  ｸﾗｽ内部処理用定数定義                                                                "
    ...
    Private Const DSPMAINTE_USER_ID As Integer = 3  'ﾒﾝﾃﾅﾝｽﾕｰｻﾞｰID
...
#Region "  ﾒｲﾝ処理                                                                              "
    ...
    Public Overrides Function ExecCmd(ByVal strMSG_RECV As String, ByRef strMSG_SEND As String) As RetCode
        ...
        Try
            ...
            objTMST_USER.FUSER_ID = strDenbunDtl(DSPMAINTE_USER_ID)           'ﾕｰｻﾞｰID
            intRet = objTMST_USER.GET_TMST_USER(False)                        '取得
            objTMST_USER.FPASS_WORD = Nothing                                 'ﾊﾟｽﾜｰﾄﾞ(Null設定)

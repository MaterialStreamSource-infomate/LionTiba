...
#Region "  ﾒｲﾝ処理                                                                              "
    ...
    Public Overrides Function ExecCmd(ByVal strMSG_RECV As String, ByRef strMSG_SEND As String) As RetCode
        ...
        Try
            ...
            'ﾄﾗｯｷﾝｸﾞ削除
            '************************
            Dim objSVR_100302 As New SVR_100302(Owner, ObjDb, ObjDbLog) 'ﾄﾗｯｷﾝｸﾞ強制完了ｸﾗｽ
            objSVR_100302.FTRK_BUF_NO = intBufNo                        'ﾊﾞｯﾌｧ№
            objSVR_100302.FPALLET_ID = strDenbunDtl(DSPPALLET_ID)       'ﾊﾟﾚｯﾄID
            ...
            If IsNotNull(objTPLN_CARRY_QUE.XPALLET_ID_AITE) Then
                ...
                intRet = objTPRG_TRK_BUF_RELAY.GET_TPRG_TRK_BUF(False)                      '取得
                If intRet = RetCode.OK Then
                    ...
                    If objTPRG_TRK_BUF_RELAY.FTRK_BUF_NO = intBufNo Then
                        ...
                        'ﾄﾗｯｷﾝｸﾞ強制完了
                        '************************
                        Dim objSVR_100302_Aite As New SVR_100302(Owner, ObjDb, ObjDbLog)    'ﾄﾗｯｷﾝｸﾞ強制完了ｸﾗｽ
                        objSVR_100302_Aite.FTRK_BUF_NO = intBufNo                           'ﾊﾞｯﾌｧ№
                        objSVR_100302_Aite.FPALLET_ID = objTPLN_CARRY_QUE.XPALLET_ID_AITE   'ﾊﾟﾚｯﾄID
                        objSVR_100302_Aite.MENTE_DELETE()                                   'ﾄﾗｯｷﾝｸﾞ削除
            ...
            '↓↓↓↓↓↓************************************************************************************************************
            'SystemMate:N.Dounoshita 2013/06/10  次処理起動

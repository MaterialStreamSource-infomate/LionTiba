...
#Region "  ｸﾗｽ内部処理用変数定義                                                                "
    ...
    Private Const XDSPTR_IDOU As Integer = 8        '搬送TO移動ﾄﾗｯｷﾝｸﾞﾊﾞｯﾌｧ№
        ...
        For ii As Integer = 1 To 2
            ...
            If ii = 1 Then
                ...
                If IsNotNull(strDenbunDtl(XDSPPALLET_ID_KO)) Then
                    intFSAGYOU_KIND = FSAGYOU_KIND_J73                  '作業種別
                Else
                    intFSAGYOU_KIND = FSAGYOU_KIND_J74                  '作業種別
                End If
            ...
            objSVR_100501.FTR_IDOU = strDenbunDtl(XDSPTR_IDOU)                          '搬送TO移動ﾄﾗｯｷﾝｸﾞﾊﾞｯﾌｧ№

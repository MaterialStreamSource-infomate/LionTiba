    ...
    Public Overrides Function ExecCmd(ByVal strMSG_RECV As String, ByRef strMSG_SEND As String) As RetCode
        ...
        Try
            ...
            If strDenbunDtl(XDSPSETTEI_EQ_ID) <> "" Then
                Call objSVR_190001.SendYasukawaMelsec_IDMainteBit(strDenbunDtl(XDSPSETTEI_EQ_ID), strDenbunDtl(XDSPTEXT_ID), strDenbunDtl(XDSPSETTEI_NUM))
            End If

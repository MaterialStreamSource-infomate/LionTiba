...
#Region "  ｸﾗｽ内部処理用定数定義                                                                "
    ...
    Private Const XDSPEQ_ID_ENUM As Integer = 3         '設備ID列挙
    Private Const XDSPTEXT_ID As Integer = 4            'ﾃｷｽﾄID
    Private Const XDSPSEND_DATA As Integer = 5          '送信ﾃﾞｰﾀ
...
#Region "  ﾒｲﾝ処理                                                                              "
    ...
    Public Overrides Function ExecCmd(ByVal strMSG_RECV As String, ByRef strMSG_SEND As String) As RetCode
        ...
        Try
            ...
            Call objSVR_190001.SendYasukawaMelsec_IDMainteWord(strDenbunDtl(XDSPEQ_ID_ENUM), strDenbunDtl(XDSPTEXT_ID), strDenbunDtl(XDSPSEND_DATA))

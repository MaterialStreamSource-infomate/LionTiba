...
#Region "  ｸﾗｽ内部処理用変数定義                                                                "
    ...
    Private Const XDSPDPL_PL_NAME As Integer = 5        'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ名称
    Private Const XDSPPROD_LINE As Integer = 6          '生産ﾗｲﾝ名称
    Private Const DSPTRK_BUF_NO As Integer = 7          '入出庫ST
...
#Region "  追加ﾒﾝﾃﾅﾝｽ                                                                           "
    ...
    Private Sub Mente_ADD(ByVal strDenbunDtl() As String)
        Try
            ...
            '========================================
            'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号存在ﾁｪｯｸ
            '========================================
            Dim objXMST_DPL_PL As New TBL_XMST_DPL_PL(Owner, ObjDb, ObjDbLog)           'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾏｽﾀ
            objXMST_DPL_PL.XDPL_PL_NO = strDenbunDtl(XDSPDPL_PL_NO)                     'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号
            intRet = objXMST_DPL_PL.GET_XMST_DPL_PL(False)                              '特定
            If intRet = RetCode.OK Then
                '(入力されたﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号が登録されている場合)
                strMsg = FRM_MSG_FRM306081_03 & "[ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号:" & objXMST_DPL_PL.XDPL_PL_NO & "]"
            ...
            'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾏｽﾀの追加
            '**************************************
            Dim obj_XMST_DPL_PL_After As New TBL_XMST_DPL_PL(Owner, ObjDb, ObjDbLog)
            obj_XMST_DPL_PL_After.XDPL_PL_NO = strDenbunDtl(XDSPDPL_PL_NO)                          'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号
            obj_XMST_DPL_PL_After.XDPL_PL_NAME = strDenbunDtl(XDSPDPL_PL_NAME)                      'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ名称
            obj_XMST_DPL_PL_After.XPROD_LINE = strDenbunDtl(XDSPPROD_LINE)                          '生産ﾗｲﾝ名称
            obj_XMST_DPL_PL_After.FTRK_BUF_NO = TO_INTEGER_NULLABLE(strDenbunDtl(DSPTRK_BUF_NO))    '入出庫ST
            Call obj_XMST_DPL_PL_After.ADD_XMST_DPL_PL()                                            '追加
...
#Region "  更新ﾒﾝﾃﾅﾝｽ                                                                           "
    ...
    Private Sub Mente_UPDATE(ByVal strDenbunDtl() As String)
        Try
            ...
            Dim objXMST_DPL_PL As New TBL_XMST_DPL_PL(Owner, ObjDb, ObjDbLog)               'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾏｽﾀ
            objXMST_DPL_PL.XDPL_PL_NO = strDenbunDtl(XDSPDPL_PL_NO)                         'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号
            objXMST_DPL_PL.GET_XMST_DPL_PL(False)                                           '特定
            objXMST_DPL_PL.XDPL_PL_NAME = strDenbunDtl(XDSPDPL_PL_NAME)                     'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ名称
            objXMST_DPL_PL.XPROD_LINE = strDenbunDtl(XDSPPROD_LINE)                         '生産ﾗｲﾝ名称
            objXMST_DPL_PL.FTRK_BUF_NO = TO_INTEGER_NULLABLE(strDenbunDtl(DSPTRK_BUF_NO))   '入出庫ST
            Call objXMST_DPL_PL.UPDATE_XMST_DPL_PL()                                        '更新
...
#Region "  削除ﾒﾝﾃﾅﾝｽ                                                                           "
    ...
    Private Sub Mente_DELETE(ByVal strDenbunDtl() As String)
        Try
            ...
            Dim objXMST_DPL_PL As New TBL_XMST_DPL_PL(Owner, ObjDb, ObjDbLog)           'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾏｽﾀ
            objXMST_DPL_PL.XDPL_PL_NO = strDenbunDtl(XDSPDPL_PL_NO)                     'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞ番号
            Call objXMST_DPL_PL.DELETE_XMST_DPL_PL()                                    '特定

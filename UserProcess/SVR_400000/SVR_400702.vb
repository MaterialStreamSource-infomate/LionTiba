...
#Region "  ｸﾗｽ内部処理用定数定義                                                                "
    ...
    Private Const XDSPGENZAI_EQ_ID As Integer = 6       '設備ID
    Private Const XDSPTEXT_ID02 As Integer = 7          'ﾃｷｽﾄID02
    Private Const XDSPGENZAI_NUM As Integer = 8         '現在数
...
#Region "  ﾒｲﾝ処理                                                                              "
    ...
    Public Overrides Function ExecCmd(ByVal strMSG_RECV As String, ByRef strMSG_SEND As String) As RetCode
        ...
        Try
            ...
            End If
            If strDenbunDtl(XDSPGENZAI_EQ_ID) <> "" Then
                Call objSVR_190001.SendYasukawaMelsec_IDMainteWord(strDenbunDtl(XDSPGENZAI_EQ_ID), strDenbunDtl(XDSPTEXT_ID02), strDenbunDtl(XDSPGENZAI_NUM))
            End If

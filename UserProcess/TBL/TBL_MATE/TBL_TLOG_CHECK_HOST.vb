...
''' ŒΩƒç›å…è∆çá√∞ÃﬁŸ∏◊Ω
''' </summary>
Public Class TBL_TLOG_CHECK_HOST
...
#Region "  ∏◊ΩïœêîíËã`                  "
    'Ãﬂ€ ﬂ√®
    Private mobjAryMe As TBL_TLOG_CHECK_HOST()                                   'ŒΩƒç›å…è∆çá
...
#Region "  Ãﬂ€ ﬂ√®íËã`                  "
    ...
    ''' ºΩ√—ïœêî (é©∏◊Ωå^îzóÒ)
    ''' </summary>
    Public ReadOnly Property ARYME() As TBL_TLOG_CHECK_HOST()
        Get
            Return mobjAryMe
        End Get
    End Property
...
#Region "  √ﬁ∞¿éÊìæ                     "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Function GET_TLOG_CHECK_HOST(Optional ByVal blnNotFoundError As Boolean = True) As RetCode
        ...
        strSQL.Append(vbCrLf & "    TLOG_CHECK_HOST")
...
#Region "  √ﬁ∞¿éÊìæ(ï°êî⁄∫∞ƒﬁ)          "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Function GET_TLOG_CHECK_HOST_ANY() As RetCode
        Dim strSQL As New StringBuilder 'SQLï∂
        Dim objDataSet As New DataSet   '√ﬁ∞¿æØƒ
        Dim strDataSetName As String    '√ﬁ∞¿æØƒñº
        Dim objRow As DataRow           '1⁄∫∞ƒﬁï™ÇÃ√ﬁ∞¿
        ...
        If objDataSet.Tables(strDataSetName).Rows.Count > 0 Then
            ...
            For ii = LBound(mobjAryMe) To UBound(mobjAryMe)
                ...
                mobjAryMe(ii) = New TBL_TLOG_CHECK_HOST(Owner, objDb, objDbLog)
...
#Region "  √ﬁ∞¿éÊìæ(∂Ω¿—íäèo)           "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Function GET_TLOG_CHECK_HOST_USER(Optional ByRef objUSER_PARAM As Object(,) = Nothing) As RetCode
...
#Region "  √ﬁ∞¿éÊìæ(∂≥›ƒ)               "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Function GET_TLOG_CHECK_HOST_COUNT() As Integer
        Dim strSQL As New StringBuilder 'SQLï∂
        Dim objDataSet As New DataSet   '√ﬁ∞¿æØƒ
        Dim strDataSetName As String    '√ﬁ∞¿æØƒñº
        Dim objRow As DataRow           '1⁄∫∞ƒﬁï™ÇÃ√ﬁ∞¿
...
#Region "  √ﬁ∞¿çXêV                     "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Sub UPDATE_TLOG_CHECK_HOST()
        Dim strSQL As New StringBuilder     'SQLï∂
        Dim strMsg As String                '“Øæ∞ºﬁ
        ...
        ElseIf IsNull(mFENTRY_DT) = True Then
            strMsg = ERRMSG_ERR_PROPERTY & "[ìoò^ì˙éû]"
            Throw New UserException(strMsg)
        End If
        ...
        If IsNull(FENTRY_DT) = True Then
            strSQL.Append(vbCrLf & "    AND FENTRY_DT IS NULL --ìoò^ì˙éû")
        Else
            ReDim Preserve strBindField(UBound(strBindField) + 1)
            ReDim Preserve objBindValue(UBound(objBindValue) + 1)
            strBindField(UBound(strBindField)) = ":" & UBound(strBindField) - 1
...
#Region "  √ﬁ∞¿í«â¡                     "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Sub ADD_TLOG_CHECK_HOST()
        Dim strSQL As New StringBuilder     'SQLï∂
        Dim strMsg As String                '“Øæ∞ºﬁ
        Dim intRetSQL As Integer            'SQLé¿çsñﬂÇËíl
        Dim objParameter(1, 0) As Object
...
#Region "  √ﬁ∞¿çÌèú                     "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Sub DELETE_TLOG_CHECK_HOST()
        Dim strSQL As New StringBuilder     'SQLï∂
        Dim strMsg As String                '“Øæ∞ºﬁ
        Dim intRetSQL As Integer            'SQLé¿çsñﬂÇËíl
        Dim objParameter(1, 0) As Object
...
#Region "  √ﬁ∞¿çÌèú(ï°êî⁄∫∞ƒﬁ)          "
    ...
    ''' <remarks></remarks>
    '''**********************************************************************************************
    Public Sub DELETE_TLOG_CHECK_HOST_ANY()
        Dim strSQL As New StringBuilder     'SQLï∂
        Dim strMsg As String                '“Øæ∞ºﬁ
        Dim intRetSQL As Integer            'SQLé¿çsñﬂÇËíl
        Dim objParameter(1, 0) As Object

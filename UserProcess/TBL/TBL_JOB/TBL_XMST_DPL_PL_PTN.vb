...
' 【機能】ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝﾏｽﾀﾃｰﾌﾞﾙｸﾗｽ
...
#Region "  ｸﾗｽ変数定義                  "
    'ﾌﾟﾛﾊﾟﾃｨ
    Private mobjAryMe As TBL_XMST_DPL_PL_PTN()                                   'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝﾏｽﾀ
    ...
    Private mXDPL_PL_PTN_COMMENT As String                                       'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ
#End Region
#Region "  ﾌﾟﾛﾊﾟﾃｨ定義                  "
    ''' <summary>
    ''' ｼｽﾃﾑ変数 (自ｸﾗｽ型配列)
...
#Region "  ﾃﾞｰﾀ取得                     "
    ...
    Public Function GET_XMST_DPL_PL_PTN(Optional ByVal blnNotFoundError As Boolean = True) As RetCode
        ...
        If IsNull(XDPL_PL_PTN_COMMENT) = False Then
            ...
            strSQL.Append(vbCrLf & "    AND XDPL_PL_PTN_COMMENT = :" & UBound(strBindField) - 1 & " --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
        End If
...
#Region "  ﾃﾞｰﾀ更新                     "
    ...
    Public Sub UPDATE_XMST_DPL_PL_PTN()
        ...
        If IsNull(mXDPL_PL_PTN_COMMENT) = True Then
            If intCount = 0 Then strSQL.Append(vbCrLf & "    XDPL_PL_PTN_COMMENT = NULL --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
            If intCount > 0 Then strSQL.Append(vbCrLf & "   ,XDPL_PL_PTN_COMMENT = NULL --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
        Else
            ReDim Preserve strBindField(UBound(strBindField) + 1)
            ReDim Preserve objBindValue(UBound(objBindValue) + 1)
            strBindField(UBound(strBindField)) = ":" & Ubound(strBindField) - 1
            objBindValue(UBound(objBindValue)) = mXDPL_PL_PTN_COMMENT
            If intCount = 0 Then strSQL.Append(vbCrLf & "    XDPL_PL_PTN_COMMENT = :" & Ubound(strBindField) - 1 & " --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
            If intCount > 0 Then strSQL.Append(vbCrLf & "   ,XDPL_PL_PTN_COMMENT = :" & Ubound(strBindField) - 1 & " --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
        End If
        intCount = intCount + 1
        strSQL.Append(vbCrLf & " WHERE")
...
#Region "  ﾃﾞｰﾀ追加                     "
    ...
    Public Sub ADD_XMST_DPL_PL_PTN()
        ...
        intCount = intCount + 1
        If IsNull(mXDPL_PL_PTN_COMMENT) = True Then
            If intCount = 0 Then strSQL.Append(vbCrLf & "    NULL --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
            If intCount > 0 Then strSQL.Append(vbCrLf & "   ,NULL --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
        Else
            ReDim Preserve strBindField(UBound(strBindField) + 1)
            ReDim Preserve objBindValue(UBound(objBindValue) + 1)
            strBindField(UBound(strBindField)) = ":" & Ubound(strBindField) - 1
            objBindValue(UBound(objBindValue)) = mXDPL_PL_PTN_COMMENT
            If intCount = 0 Then strSQL.Append(vbCrLf & "    :" & Ubound(strBindField) - 1 & " --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
            If intCount > 0 Then strSQL.Append(vbCrLf & "   ,:" & Ubound(strBindField) - 1 & " --ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ")
        End If
        intCount = intCount + 1
        strSQL.Append(vbCrLf & " )")
...
#Region "  ﾌﾟﾛﾊﾟﾃｨｺﾋﾟｰ                  "
    Public Sub COPY_PROPERTY(ByVal objObject As Object)
        ...
        If IsNothing(objType.GetProperty("XDPL_PL_PTN_COMMENT")) = False Then mXDPL_PL_PTN_COMMENT = objObject.XDPL_PL_PTN_COMMENT                     'ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ
...
#Region "  ｴﾗｰﾒｯｾｰｼﾞ文字列作成01        "
    ...
    Private Sub MAKE_ERRMSG01(ByRef strMsg As String)
        ...
        strMsg &= "[ﾃｰﾌﾞﾙ名:ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝﾏｽﾀ]"
        ...
        If IsNotNull(XDPL_PL_PTN_COMMENT) Then
            strMsg &= "[ﾃﾞﾊﾟﾚ･ﾊﾟﾚﾀｲｻﾞﾊﾟﾀｰﾝｺﾒﾝﾄ:" & XDPL_PL_PTN_COMMENT & "]"
        End If

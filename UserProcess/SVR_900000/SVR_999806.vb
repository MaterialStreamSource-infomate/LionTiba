...
'
' 【名称】ﾏﾃﾘｱﾙｽﾄﾘｰﾑ標準機能
' 【機能】Melsec電文解析後、他ﾌｨｰﾙﾄﾞにﾃﾞｰﾀをｾｯﾄする05
            ...
            If intRet = RetCode.OK Then
                For ii As Integer = 0 To UBound(objAryXLOG_MELSEC.ARYME)
                    ...
                    Try
                        ...
                        objXMST_XCOMMENT01_01.FEQ_ID = objXLOG_MELSEC.FEQ_ID            '設備ID
                        objXMST_XCOMMENT01_01.XCOMMENT01 = objXLOG_MELSEC.XCOMMENT01    'ｺﾒﾝﾄ01
                        intRet = objXMST_XCOMMENT01_01.GET_XMST_XCOMMENT01_01(False)    '取得
                        If intRet = RetCode.OK Then
                            objXLOG_MELSEC.XCOMMENT01_01 = objXMST_XCOMMENT01_01.XCOMMENT01_01
                        End If

...
#Region "  共通変数、共通定数"
    ...
    Private mstrRecvByte As String              '受信ﾊﾞｲﾄ
    ...
    'その他
    '' '' ''Private mobjLogWrite As clsWriteLog          'ﾛｸﾞ書込みｵﾌﾞｼﾞｪｸﾄ
    ...
    '' '' ''Private Const MESSAGE_MESSAGE As String = "[Message]"
    '' '' ''Private Const MESSAGE_ERRMESSAGE As String = "[ErrMessage]"
    '' '' ''Private Const MESSAGE_UERRMESSAGE As String = "[UserErrMessage]"
    ...
    '' ''    Receive          '受信ﾒｯｾｰｼﾞ
    '' ''    Message          'ﾒｯｾｰｼﾞ
    '' ''    ErrMessage       'ｴﾗｰﾒｯｾｰｼﾞ
    '' ''    UErrMessage      'ﾕｰｻﾞｰｴﾗｰﾒｯｾｰｼﾞ
    '' ''End Enum

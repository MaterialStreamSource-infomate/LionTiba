...
#Region "  共通変数、共通定数"
    ...
    '' ''Private mstrLOGFILE_NAME As String      'ﾛｸﾞﾌｧｲﾙ名
    '' ''Private mstrLOGFILE_NAME_OLD As String  'ﾛｸﾞﾌｧｲﾙ名_OLD
    '' ''Private mintLOGFILE_SIZE As Integer     'ﾛｸﾞﾌｧｲﾙｻｲｽﾞ
    Private mbytReceive() As Byte           'ｿｹｯﾄ受信ﾊﾞｲﾄ
    ...
    '' ''Protected mobjLogWrite As clsWriteLog      'ﾛｸﾞ書込み


    '***********************************************************************************************
    '共通定数
    '***********************************************************************************************
    '' ''Private Const MESSAGE_SEND As String = "[SEND]"
    '' ''Private Const MESSAGE_RECV As String = "[RECV]"
    '' ''Private Const MESSAGE_ETC As String = "[etc ]"
    '' ''Private Const MESSAGE_SIZE As String = "[SIZE = "

    '' ''Private Const LOGFILE_NAME_DEFAULT As String = "clsSocketSend.log"
    '' ''Private Const LOGFILE_NAME_OLD_DEFAULT As String = "clsSocketSend_OLD.log"
    '' ''Private Const LOGFILE_SIZE_DEFAULT As Integer = 5000000
...
#Region "  ﾌﾟﾛﾊﾟﾃｨ"
    ...
    ''' =======================================
    ''' <summary>ｿｹｯﾄ受信ﾊﾞｲﾄ</summary>
    ''' <remarks></remarks>
    ''' =======================================
    Public Property bytReceive() As Byte()
        Get
            Return mbytReceive
        End Get

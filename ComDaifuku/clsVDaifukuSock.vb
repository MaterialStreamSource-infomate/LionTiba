...
'
' 【名称】ﾏﾃﾘｱﾙｽﾄﾘｰﾑ標準機能
' 【機能】DAIFUKU通信ｸﾗｽ ﾊﾞｰﾁｬﾙAGC(ｿｹｯﾄ通信)
' 【作成】SIT
'**********************************************************************************************

Public Class clsVDaifukuSock
...
#Region "  共通変数             "
    ...
    Private mobjSock As clsSocketListener       'ｿｹｯﾄ送信ｸﾗｽ(Listener)
    ...
    '固定値
    '==================================================
    Private Const MSG_001 As String = "回線ｵｰﾌﾟﾝ完了。"
    Private Const MSG_002 As String = "回線ｸﾛｰｽﾞ完了。"
...
#Region "  通信ｵｰﾌﾟﾝ            "
    ...
    Public Sub Open()
        ...
        If IsNothing(mobjSock) = True Then
            '(ｿｹｯﾄﾘｽﾅｰｵﾌﾞｼﾞｪｸﾄが存在しなかった場合)
            mobjSock = New clsSocketListener(mobjOwner)
        End If

        mobjSock.intPortNo = mintSockSendPort             'ﾎﾟｰﾄNo
        mobjSock.intBackLog = 10                          '保留中の接続のｷｭｰの最大長
        mobjSock.Listen()                                 '待機

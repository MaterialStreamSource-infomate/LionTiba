...
#Region "  ﾃﾞｰﾀｾｯﾄへ一行ﾃﾞｰﾀ追加"
    ...
    ''' <param name="strData01">ﾃﾞｰﾀｾｯﾄにｾｯﾄするﾃｷｽﾄﾃﾞｰﾀ01</param>
    ''' <param name="strData02">ﾃﾞｰﾀｾｯﾄにｾｯﾄするﾃｷｽﾄﾃﾞｰﾀ02</param>
    ''' <param name="strData03">ﾃﾞｰﾀｾｯﾄにｾｯﾄするﾃｷｽﾄﾃﾞｰﾀ03</param>
    ''' <param name="strData04">ﾃﾞｰﾀｾｯﾄにｾｯﾄするﾃｷｽﾄﾃﾞｰﾀ04</param>
    ''' <param name="strData05">ﾃﾞｰﾀｾｯﾄにｾｯﾄするﾃｷｽﾄﾃﾞｰﾀ05</param>
    ''' <remarks></remarks>
    ''' *******************************************************************************************************************

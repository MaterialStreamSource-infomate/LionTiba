...
#Region "  ﾌｨﾙﾀWhere句ｸﾘｯｸ"
    ...
    ''' <remarks></remarks>
    ''' *******************************************************************************************************************
    Private Sub tsmSQLFilterWhere_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmSQLFilterWhere.Click
        Try
            Call tsmSQLFilterWhereClickProcess()
        Catch ex As Exception
            ComError(ex)
        End Try
    End Sub
...
#Region "  ﾌｨﾙﾀWhere句ｸﾘｯｸ処理                      "
    ...
    ''' <remarks></remarks>
    ''' *******************************************************************************************************************
    Private Sub tsmSQLFilterWhereClickProcess()


        '********************************************************************
        'ﾌｨﾙﾀWhere句追加
        '********************************************************************
        txtSQL.Text &= mobjFRM_299010.strSQLFilterWhere

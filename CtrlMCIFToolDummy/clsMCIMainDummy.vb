...
#Region "  共通変数02           "
    ...
    Private mobjMCIMain As CtrlMCIF.clsMCIMain          '本当の通信ﾌﾟﾛｸﾞﾗﾑｸﾗｽ
...
#Region "  ｺﾝｽﾄﾗｸﾀ              "
    ...
    Public Sub New(ByVal objOwner As Object, _
        ...
        Try
            ...
            mdtmNow = Now
            mobjMCIMain = New CtrlMCIF.clsMCIMain(objOwner, objDb, objDbLog)    '本当の通信ﾌﾟﾛｸﾞﾗﾑｸﾗｽ
...
#Region "  初期化               "
    ...
    Public Sub Initialize()
        ...
        'Configﾌｧｲﾙ情報取得(標準部分)
        '*****************************************************
        Dim objConfig As New clsConnectConfig(CONFIG_MCIF_DUMMY)                                     'Configﾌｧｲﾙ接続ｸﾗｽ生成

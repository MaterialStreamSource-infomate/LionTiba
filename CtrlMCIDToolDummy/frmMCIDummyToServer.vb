...
#Region "  ﾌｫｰﾑﾛｰﾄﾞ"
    ...
    Private Sub frmE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Dim objConfig = New clsConnectConfig(CONFIG_MCID_DUMMY)                     'Configﾌｧｲﾙ接続ｸﾗｽ生成
            ...
            mobjMCIMain = New CtrlMCID.clsMCIMain(Nothing, Nothing, Nothing)            '本当の通信ﾌﾟﾛｸﾞﾗﾑｸﾗｽ
            ...
            'ﾃｷｽﾄﾎﾞｯｸｽ初期化
            '************************************
            txtBCR01HINMEI_CD.Text = "123456"                   '品名ｺｰﾄﾞ
            txtBCR01SEIZOU_DT.Text = Format(Now, "yyyyMMdd")    '製造年月日
            txtBCR01PALLET_NO.Text = "0001"                     'ﾊﾟﾚｯﾄ№
...
#Region "  ｲﾍﾞﾝﾄ                "
    Private Sub cmd01_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd01.Click
        Try
            ...
            strData &= gobjMCIToServer.txtBCR01HINMEI_CD.Text        '品名ｺｰﾄﾞ
            strData &= gobjMCIToServer.txtBCR01SEIZOU_DT.Text        '製造年月日
            strData &= gobjMCIToServer.txtBCR01KOUJYO_NO.Text        '工場№
            strData &= gobjMCIToServer.txtBCR01LINE_CD.Text          'ﾗｲﾝｺｰﾄﾞ
            strData &= gobjMCIToServer.txtBCR01PALLET_NO.Text        'ﾊﾟﾚｯﾄ№
            strData &= gobjMCIToServer.txtBCR01VOL.Text              '積み数
            strData &= gobjMCIToServer.txtBCR01KENSA_KUBUN.Text      '検査区分
            strData &= gobjMCIToServer.txtBCR01AB_KUBUN.Text         'AB区分
            ...
            'ﾃｷｽﾄﾎﾞｯｸｽ      更新
            '************************************
            txtBCR01PALLET_NO.Text = ZERO_PAD(TO_INTEGER(txtBCR01PALLET_NO.Text) + 1, 4)       'ﾊﾟﾚｯﾄ№

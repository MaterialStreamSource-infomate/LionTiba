...
#Region "  ｿｹｯﾄ送信                                 "
    ...
    Private Sub SendSocket01()
        ...
        objTelegram.FORMAT_ID = FORMAT_DSP_PRI & FSYORI_ID_J400703    'ﾌｫｰﾏｯﾄ名ｾｯﾄ
        ...
        objTelegram.SETIN_DATA("XDSPSETTEI_NUM", IIf(txtSETTEI_VOL.Text = "0", "0", "1"))   '設定数

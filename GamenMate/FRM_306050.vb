...
#Region "　共通変数　                           "
    ...
    'ｸﾞﾘｯﾄﾞ項目
    Enum menmListCol
        XMAKER_CD               '包材ﾒｰｶｰﾏｽﾀ.			ﾒｰｶ-ｺｰﾄﾞ
        XMAKER_NAME             '包材ﾒｰｶｰﾏｽﾀ.			ﾒｰｶ-名
...
#Region "  構造体定義                           "
    ...
    Private Structure SEARCH_ITEM
        Dim XMAKER_CD As String        'ﾒｰｶ-ｺｰﾄﾞ
    End Structure
#End Region
#Region "　ｲﾍﾞﾝﾄ　                              "
#Region "　ﾌｫｰﾑｱｸﾃｨﾌﾞ                           "
...
#Region "  F4(追加)　ﾎﾞﾀﾝ押下処理　             "
    ...
    Public Overrides Sub F4Process()
        ...
        ' ﾌﾟﾛﾊﾟﾃｨｾｯﾄ
        '************************************
        If IsNull(gobjFRM_306051) = False Then
            gobjFRM_306051.Close()
            gobjFRM_306051.Dispose()
            gobjFRM_306051 = Nothing
        End If
        gobjFRM_306051 = New FRM_306051
        Call SetProperty(BUTTONMODE_ADD)                   'ﾌﾟﾛﾊﾟﾃｨｾｯﾄ
        gobjFRM_306051.userButtonMode = BUTTONMODE_ADD     'ﾎﾞﾀﾝ

        Dim intRet As DialogResult
        intRet = gobjFRM_306051.ShowDialog()            '展開
...
#Region "  F5(変更)　ﾎﾞﾀﾝ押下処理　             "
    ...
    Public Overrides Sub F5Process()
        ...
        gobjFRM_306051.userButtonMode = BUTTONMODE_UPDATE       'ﾎﾞﾀﾝ
...
#Region "  F6(削除)　ﾎﾞﾀﾝ押下処理　             "
    ...
    Public Overrides Sub F6Process()
        ...
        gobjFRM_306051.userButtonMode = BUTTONMODE_DELETE     'ﾎﾞﾀﾝ
...
#Region "　ｸﾞﾘｯﾄﾞ表示　                         "
    ...
    Public Overrides Sub grdListDisplayChild()
        ...
        strSQL &= vbCrLf & "     XMST_WRAPPING_MAKER.XMAKER_CD "                          '包材ﾒｰｶｰﾏｽﾀ.			ﾒｰｶ-ｺｰﾄﾞ
        strSQL &= vbCrLf & "   , XMST_WRAPPING_MAKER.XMAKER_NAME "                         '包材ﾒｰｶｰﾏｽﾀ.			ﾒｰｶ-名
...
#Region "  ﾒﾝﾃﾅﾝｽ入力画面へﾌﾟﾛﾊﾟﾃｨｾｯﾄ　         "
    ...
    Private Sub SetProperty(ByVal intBtnMode As Integer)
        ...
        If intBtnMode = BUTTONMODE_ADD Then
            '(追加のとき)
            gobjFRM_306051.userXMAKER_CD = Nothing             'ﾒｰｶ-ｺｰﾄﾞ

        ElseIf intBtnMode = BUTTONMODE_UPDATE Then
            '(変更のとき)
            intRow = grdList.SelectedRows(0).Index
            gobjFRM_306051.userXMAKER_CD = TO_STRING(grdList.Item(menmListCol.XMAKER_CD, intRow).Value)     'ﾒｰｶ-ｺｰﾄﾞ

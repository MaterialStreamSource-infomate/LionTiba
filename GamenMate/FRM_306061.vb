...
#Region "  共通変数　                           "
    ...
    'ﾃｰﾌﾞﾙｸﾗｽ
    Dim mobjXMST_PROD_LINE As TBL_XMST_PROD_LINE    '生産ﾗｲﾝﾏｽﾀ
...
#Region " ﾌｫｰﾑﾛｰﾄﾞ                              "
    ...
    '【戻値】
    '*******************************************************************************************************************
    Private Sub FRM_306061_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
...
#Region " ﾌｫｰﾑｱﾝﾛｰﾄﾞ                            "
    ...
    '【戻値】
    '*******************************************************************************************************************
    Private Sub FRM_306061_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
...
#Region "  ﾌｫｰﾑﾛｰﾄﾞ     処理                    "
    ...
    Private Sub LoadProcess()
        ...
        ' 生産ﾗｲﾝﾏｽﾀ情報の特定
        '**********************************************************
        mobjXMST_PROD_LINE = New TBL_XMST_PROD_LINE(gobjOwner, gobjDb, Nothing)
        If IsNull(mstrXPROD_LINE) = False Then
            mobjXMST_PROD_LINE.XPROD_LINE = mstrXPROD_LINE               '生産ﾗｲﾝ№
            mobjXMST_PROD_LINE.GET_XMST_PROD_LINE(False)
        End If
        ...
        txtXPROD_LINE_NAME.Text = TO_STRING(mobjXMST_PROD_LINE.XPROD_LINE_NAME)         '生産ﾗｲﾝ名称
        ...
        cboFHINMEI_CD.Text = mobjXMST_PROD_LINE.FHINMEI_CD
        ...
        ' 入庫区分ｺﾝﾎﾞﾎﾞｯｸｽ         ｾｯﾄ
        '===================================
        Call gobjComFuncFRM.cboSetup(FDISP_ID_SKOTEI, Me.cboFIN_KUBUN, True, mobjXMST_PROD_LINE.FIN_KUBUN)
    ...
    Protected Overridable Function InputCheck() As Boolean
        ...
        Select Case mintButtonMode
            Case BUTTONMODE_ADD
                ...
                '生産ﾗｲﾝ№重複ﾁｪｯｸ
                '========================================
                Dim objXMST_PROD_LINE As New TBL_XMST_PROD_LINE(gobjOwner, gobjDb, Nothing)       '生産ﾗｲﾝﾏｽﾀ
                Dim intRet As Integer
                objXMST_PROD_LINE.XPROD_LINE = txtXPROD_LINE.Text                               '生産ﾗｲﾝ№
                intRet = objXMST_PROD_LINE.GET_XMST_PROD_LINE(False)                            '特定
...
#Region "  ｿｹｯﾄ送信                             "
    ...
    Private Sub SendSocket01()
        ...
        objTelegram.FORMAT_ID = FORMAT_DSP_PRI & FSYORI_ID_J400605                  'ﾌｫｰﾏｯﾄ名ｾｯﾄ

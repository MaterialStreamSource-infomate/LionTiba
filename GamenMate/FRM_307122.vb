...
Public Class FRM_307122

#Region "  共通変数　                               "

    Private mFlag_Form_Load As Boolean = True           '画面展開ﾌﾗｸﾞ

    Private mstrFEQ_ID() As String                      '該当設備ID
...
#Region "　ﾌｫｰﾑﾛｰﾄﾞ　                               "
    ...
    '【戻値】
    '*******************************************************************************************************************
    Private Sub FRM_307122_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
...
#Region "　ﾌｫｰﾑｱﾝﾛｰﾄﾞ　                             "
    ...
    '【戻値】
    '*******************************************************************************************************************
    Private Sub FRM_307122_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
...
#Region "  ﾌｫｰﾑﾛｰﾄﾞ     処理                        "
    ...
    Private Sub LoadProcess()
        ...
        objXDSP_PLC_MAINTE.GET_XDSP_PLC_MAINTE()

        mstrFEQ_ID = TO_STRING(objXDSP_PLC_MAINTE.XEQ_ID_MAINTE).Split(KUGIRI01)
...
#Region "  ｿｹｯﾄ送信                                 "
    ...
    Private Sub SendSocket01()
        ...
        If mstrFEQ_ID(3) <> "" Then
            '(4ﾜｰﾄﾞの場合)
            strXEQ_ID_ENUM = TO_STRING(mstrFEQ_ID(0) & "," & mstrFEQ_ID(1) & "," & mstrFEQ_ID(2) & "," & mstrFEQ_ID(3))   '設備ID列挙
            strXSEND_DATA = strData01_10 & "," & strData02_10 & "," & strData03_10 & "," & strData04_10             '送信ﾃﾞｰﾀ

        Else
            '(3ﾜｰﾄﾞの場合)
            strXEQ_ID_ENUM = TO_STRING(mstrFEQ_ID(0) & "," & mstrFEQ_ID(1) & "," & mstrFEQ_ID(2))                   '設備ID列挙
            strXSEND_DATA = strData01_10 & "," & strData02_10 & "," & strData03_10                                  '送信ﾃﾞｰﾀ

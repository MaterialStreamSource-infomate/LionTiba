...
#Region "  共通変数　                               "
    ...
    Protected mstrPLC_Mainte_Target As String           'ﾒﾝﾃﾅﾝｽ対象
...
#Region "  ﾌﾟﾛﾊﾟﾃｨ定義　                            "
    ...
    ''' =======================================
    ''' <summary>ﾒﾝﾃﾅﾝｽ対象</summary>
    ''' <remarks></remarks>
    ''' =======================================
    Public Property userPLC_Mainte_Target() As String
        Get
            Return mstrPLC_Mainte_Target
        End Get
        Set(ByVal value As String)
            mstrPLC_Mainte_Target = value
        End Set
    End Property
...
#Region "  ﾌｫｰﾑﾛｰﾄﾞ     処理                        "
    ...
    Private Sub LoadProcess()
        ...
        ' ﾃｷｽﾄ                ｾｯﾄ
        '**********************************************************
        If mstrPLC_Mainte_Target = 1 Then
            '(設定数変更の場合)
            txtSETTEI_VOL.Text = mstrPLC_FEQ_ID_VOL01             '設定数
            txtSETTEI_VOL.Enabled = True

            txtGENZAI_VOL.Text = mstrPLC_FEQ_ID_VOL02             '現在数
            txtGENZAI_VOL.Enabled = False

            lblSETTEI_VOL.Visible = False

        ElseIf mstrPLC_Mainte_Target = 2 Then
            '(現在数変更の場合)

            txtSETTEI_VOL.Visible = False

            txtGENZAI_VOL.Text = mstrPLC_FEQ_ID_VOL02             '現在数
            txtGENZAI_VOL.Enabled = True

            lblSETTEI_VOL.Text = mstrPLC_FEQ_ID_VOL01             '設定数
            lblSETTEI_VOL.Visible = True
        ...
        Select Case "a"
            Case "a"
                ...
                If mstrPLC_Mainte_Target = 1 Then
                    ...
                    '設定数
                    '========================================
                    If txtSETTEI_VOL.Text = "" Then
                        Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307101_01, _
                                         PopupFormType.Ok, _
                                         PopupIconType.Information)
                        Exit Select
                    End If

                    If TO_INTEGER(txtSETTEI_VOL.Text) > MAX_BIT Then
                        Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307101_03, _
                                         PopupFormType.Ok, _
                                         PopupIconType.Information)
                        Exit Select
                    End If
                ...
                ElseIf mstrPLC_Mainte_Target = 2 Then
                    ...
                    If txtGENZAI_VOL.Text = "" Then
                        Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307101_02, _
                                         PopupFormType.Ok, _
                                         PopupIconType.Information)
                        Exit Select
                    End If
                    ...
                    If TO_INTEGER(txtGENZAI_VOL.Text) > MAX_BIT Then
                        Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307101_04, _
                                         PopupFormType.Ok, _
                                         PopupIconType.Information)
                        Exit Select
                    End If
...
#Region "  ｿｹｯﾄ送信                                 "
    ...
    Private Sub SendSocket01()
        ...
        If mstrPLC_Mainte_Target = 1 Then
            ...
            objTelegram.SETIN_DATA("XDSPSETTEI_NUM", txtSETTEI_VOL.Text)                        '設定数

...
#Region "  ﾌｫｰﾑﾛｰﾄﾞ     処理                        "
    ...
    Private Sub LoadProcess()
        ...
        '保留区分 ｺﾝﾎﾞﾎﾞｯｸｽ      ｾｯﾄ
        '===================================
        Call gobjComFuncFRM.cboSetup(FDISP_ID_SKOTEI, cboFHORYU_KUBUN, False, -1)
        ...
        Select Case udtCheck_Case
            Case menmCheckCase.Entry_Click
                ...
                If cboFHORYU_KUBUN.Text = "" Then
                    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM305061_02, _
                                     PopupFormType.Ok, _
...
#Region "  ｿｹｯﾄ送信02                             　"
    ...
    Private Function SendSocket02() As Boolean
        ...
        udtRet = gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM305061_01, PopupFormType.Ok_Cancel, PopupIconType.Quest)
        ...
        For ii As Integer = LBound(mstrFPALLET_ID) To UBound(mstrFPALLET_ID)
            ...
            objTelegramSub.SETIN_DATA("DSPHORYU_KUBUN", strFHORYU_KUBUN)                        '保留区分
            objTelegramSub.SETIN_DATA("XDSPKENSA_KUBUN", "")          '検査区分
            '↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
        ...
        strErrMsg = FRM_MSG_FRM305061_03

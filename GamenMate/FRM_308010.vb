...
#Region "　共通変数　                               "
    ...
    Enum menmListCol
        ...
        XKENSA_KUBUN        ' 在庫情報       .検査区分(非表示)
        XKENSA_KUBUN_DSP    ' 在庫情報       .検査区分
        FTR_VOL             ' 在庫情報       .搬送管理量
...
#Region "  F6(検査結果登録)  ﾎﾞﾀﾝ押下処理　         "
    ...
    Public Overrides Sub F6Process()
        ...
        ' ﾌﾟﾛﾊﾟﾃｨｾｯﾄ
        '************************************
        If IsNull(gobjFRM_308011) = False Then
            gobjFRM_308011.Close()
            gobjFRM_308011.Dispose()
            gobjFRM_308011 = Nothing
        End If
        gobjFRM_308011 = New FRM_308011
        Call SetProperty(gobjFRM_308011)                  'ﾌﾟﾛﾊﾟﾃｨｾｯﾄ

        Dim intRet As DialogResult
        intRet = gobjFRM_308011.ShowDialog()            '画面表示
...
#Region "　ﾌﾟﾛﾊﾟﾃｨｾｯﾄ(詳細)　                       "
    ...
    '【戻値】
    '*******************************************************************************************************************
    Private Sub SetProperty(ByVal objForm As FRM_308011)

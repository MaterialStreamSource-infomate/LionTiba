    ...
    Protected Overridable Function InputCheck(ByVal udtCheck_Case As menmCheckCase) As Boolean
        ...
        Select Case udtCheck_Case
            Case menmCheckCase.Send_Click
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_01, _
                '                     PopupFormType.Ok, _
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_02, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_03, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_04, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_05, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_06, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_07, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_08, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_09, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_10, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
                ...
                '    Call gobjComFuncFRM.DisplayPopup(FRM_MSG_FRM307091_11, _
                '                     PopupFormType.Ok, _
                '                     PopupIconType.Information)
                '    Exit Select
                'End If
...
#Region "  ｿｹｯﾄ送信                                 "
    ...
    Private Sub SendSocket01()
        ...
        strXEQ_ID_ENUM = TO_STRING(objXDSP_PLC_MAINTE.XEQ_ID_MAINTE & "," & objXDSP_PLC_MAINTE_KO.XEQ_ID_MAINTE)                                '設備ID列挙
        strXSEND_DATA = strData01_10 & "," & strData02_10 & "," & strData03_10 & "," & strData04_10 & "," & strData05_10 & "," & strData06_10   '送信ﾃﾞｰﾀ

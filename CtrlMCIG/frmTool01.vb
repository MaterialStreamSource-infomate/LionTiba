...
#Region "  読込                         ﾎﾞﾀﾝｸﾘｯｸ"
    Private Sub cmdRead01_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdRead01.Click
        ...
        Try
            ...
            intRetPLC = gobjMain.SeqWordReadCmndSend(txtReadSend01_03.Text, txtReadSend01_04.Text, bytRead)
    ...
    '        '*****************************************************
    '        Dim bytRead() As Integer = Nothing
    '        intRetPLC = objPLC.SeqWordReadCmndSend(txtReadSend01_01.Text, txtReadSend01_03.Text, txtReadSend01_04.Text, bytRead)
    '        If intRetPLC <> RetCode.OK Then
    '            strMsg = "PLCﾚｼﾞｽﾀ内容取得失敗。"
    '            txtReadRecv01_04.Text = strMsg
    '            Throw New Exception(strMsg)
...
#Region "  書込                         ﾎﾞﾀﾝｸﾘｯｸ"
    Private Sub cmdWrite01_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdWrite01.Click
        Try
            ...
            '*****************************************************
            Dim bytRead() As Integer = Nothing
            intRetPLC = gobjMain.SeqWordWriteCmndSend(txtWriteSend01_03.Text, intWrite)
            If intRetPLC <> RetCode.OK Then
    ...
    '            intWrite(ii) = TO_INTEGER(strWrite(ii))
    '        Next
    '        intRetPLC = objPLC.SeqWordWriteCmndSend(txtWriteSend01_01.Text, txtWriteSend01_03.Text, intWrite)
    '        If intRetPLC <> RetCode.OK Then
    '            strMsg = "PLCﾚｼﾞｽﾀ内容書込失敗。"
    '            Throw New Exception(strMsg)
    '        End If

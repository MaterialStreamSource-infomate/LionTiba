...
#Region "  ﾌｫｰﾑﾛｰﾄﾞ         "
    ...
    Private Sub FormLoadProcess()
        ...
        '二重起動ﾁｪｯｸ
        '*********************************************
        If UBound(Diagnostics.Process.GetProcessesByName(Diagnostics.Process.GetCurrentProcess.ProcessName)) >= 1 Then
        ...
        Try
            ...
            gobjMain = New clsMCIMain(mobjOwner)                            'MCI通信ｵﾌﾞｼﾞｪｸﾄ生成
            gobjMCI = Me                                                    '自ﾌｫｰﾑｾｯﾄ
